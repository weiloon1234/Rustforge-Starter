...
impl core_db::common::model_api::QueryModel for HttpClientLogModel {
    ...
    fn query_root<'db>(db: DbConn<'db>, base_url: Option<String>) -> Self::InnerQuery<'db> {
        QueryState::new(db, base_url, "id, request_url, request_method, request_headers, request_body, response_status, response_headers, response_body, duration_ms, created_at")
    }
    fn query_all<'db>(state: Self::InnerQuery<'db>) -> core_db::common::model_api::BoxModelFuture<'db, Vec<Self::Record>> {
        Box::pin(async move { HttpClientLogQueryInner::from_state(state).get().await })
    }
    fn query_first<'db>(state: Self::InnerQuery<'db>) -> core_db::common::model_api::BoxModelFuture<'db, Option<Self::Record>> {
        Box::pin(async move { HttpClientLogQueryInner::from_state(state).first().await })
    }
    fn query_find<'db>(state: Self::InnerQuery<'db>, id: Self::Pk) -> core_db::common::model_api::BoxModelFuture<'db, Option<Self::Record>> {
        Box::pin(async move { HttpClientLogQueryInner::from_state(state).find(id).await })
    }
    fn query_count<'db>(state: Self::InnerQuery<'db>) -> core_db::common::model_api::BoxModelFuture<'db, i64> {
        Box::pin(async move { HttpClientLogQueryInner::from_state(state).count().await })
    }
    fn query_delete<'db>(state: Self::InnerQuery<'db>) -> core_db::common::model_api::BoxModelFuture<'db, u64> {
        Box::pin(async move { HttpClientLogQueryInner::from_state(state).delete().await })
    }
    fn query_paginate<'db>(state: Self::InnerQuery<'db>, page: i64, per_page: i64) -> core_db::common::model_api::BoxModelFuture<'db, core_db::common::model_api::Page<Self::Record>> {
        Box::pin(async move {
            let page = HttpClientLogQueryInner::from_state(state).paginate(page, per_page).await?;
...
impl core_db::common::model_api::QueryField<HttpClientLogModel> for HttpClientLogDbCol {
    type Value = BindValue;
    fn where_col<'db>(field: Self, state: <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: <Self as core_db::common::model_api::QueryField<HttpClientLogModel>>::Value) -> <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.where_col_str(field.as_sql(), op, value)
    }
    fn or_where_col<'db>(field: Self, state: <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: <Self as core_db::common::model_api::QueryField<HttpClientLogModel>>::Value) -> <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.or_where_col_str(field.as_sql(), op, value)
    }
    fn where_in<'db>(field: Self, state: <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, values: &[<Self as core_db::common::model_api::QueryField<HttpClientLogModel>>::Value]) -> <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.where_in_str(field.as_sql(), values)
    }
    fn order_by<'db>(field: Self, state: <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, dir: OrderDir) -> <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.order_by_str(field.as_sql(), dir)
    }
    fn where_null<'db>(field: Self, state: <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>) -> <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.where_null_str(field.as_sql())
    }
    fn where_not_null<'db>(field: Self, state: <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>) -> <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
...
{
    type Value = T;
    fn where_col<'db>(field: Self, state: <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: Self::Value) -> <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
    ...
    fn or_where_col<'db>(field: Self, state: <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: Self::Value) -> <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        let col = resolve_http_client_log_db_col(field.as_sql()).expect("typed generated column must resolve to an internal db column");
        state.or_where_col_str(col.as_sql(), op, value.into())
    }
    fn where_in<'db>(field: Self, state: <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, values: &[Self::Value]) -> <HttpClientLogModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        let col = resolve_http_client_log_db_col(field.as_sql()).expect("typed generated column must resolve to an internal db column");
