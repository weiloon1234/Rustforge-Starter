...
impl core_db::common::model_api::QueryModel for AdminModel {
    ...
    fn query_paginate<'db>(state: Self::InnerQuery<'db>, page: i64, per_page: i64) -> core_db::common::model_api::BoxModelFuture<'db, core_db::common::model_api::Page<Self::Record>> {
        Box::pin(async move {
            let page = AdminQueryInner::from_state(state).paginate(page, per_page).await?;
...
impl core_db::common::model_api::QueryField<AdminModel> for AdminDbCol {
    type Value = BindValue;
    fn where_col<'db>(field: Self, state: <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: <Self as core_db::common::model_api::QueryField<AdminModel>>::Value) -> <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.where_col_str(field.as_sql(), op, value)
    }
    fn or_where_col<'db>(field: Self, state: <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: <Self as core_db::common::model_api::QueryField<AdminModel>>::Value) -> <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.or_where_col_str(field.as_sql(), op, value)
    }
    fn where_in<'db>(field: Self, state: <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, values: &[<Self as core_db::common::model_api::QueryField<AdminModel>>::Value]) -> <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.where_in_str(field.as_sql(), values)
    }
    fn order_by<'db>(field: Self, state: <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, dir: OrderDir) -> <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.order_by_str(field.as_sql(), dir)
    }
    fn where_null<'db>(field: Self, state: <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>) -> <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.where_null_str(field.as_sql())
    }
    fn where_not_null<'db>(field: Self, state: <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>) -> <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
...
{
    type Value = T;
    fn where_col<'db>(field: Self, state: <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: Self::Value) -> <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
    ...
    fn or_where_col<'db>(field: Self, state: <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: Self::Value) -> <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        let col = resolve_admin_db_col(field.as_sql()).expect("typed generated column must resolve to an internal db column");
        state.or_where_col_str(col.as_sql(), op, value.into())
    }
    fn where_in<'db>(field: Self, state: <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, values: &[Self::Value]) -> <AdminModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        let col = resolve_admin_db_col(field.as_sql()).expect("typed generated column must resolve to an internal db column");
