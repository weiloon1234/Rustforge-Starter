...
impl<'db> WebhookLogCreateInner<'db> {
    pub fn new(db: DbConn<'db>, base_url: Option<String>) -> Self {
        Self {
            state: core_db::common::model_api::CreateState::new(db, base_url, "webhook_logs"),
        }
    }
...
pub async fn save(self) -> Result<WebhookLogRecord> {
    ...
    async fn save_with_db<'tx>(mut self, db: DbConn<'tx>) -> Result<(WebhookLogRecord, WebhookLogRow)> {
...
impl<'db> WebhookLogPatchInner<'db> {
    pub fn new(db: DbConn<'db>, base_url: Option<String>) -> Self {
        Self {
            state: core_db::common::model_api::PatchState::new(db, base_url, "webhook_logs"),
        }
    }
...
pub fn set_id(mut self, val: uuid::Uuid) -> Self {
        self.state = self.state.assign_col(WebhookLogDbCol::Id.as_sql(), val.into());
        self
    }
    pub fn set_request_url(mut self, val: String) -> Self {
        self.state = self.state.assign_col(WebhookLogDbCol::RequestUrl.as_sql(), val.into());
        self
    }
    pub fn set_request_method(mut self, val: String) -> Self {
        self.state = self.state.assign_col(WebhookLogDbCol::RequestMethod.as_sql(), val.into());
        self
    }
    pub fn set_request_headers(mut self, val: Option<serde_json::Value>) -> Self {
        self.state = self.state.assign_col(WebhookLogDbCol::RequestHeaders.as_sql(), val.into());
        self
    }
    pub fn set_request_body(mut self, val: Option<String>) -> Self {
        self.state = self.state.assign_col(WebhookLogDbCol::RequestBody.as_sql(), val.into());
        self
    }
    pub fn set_response_status(mut self, val: Option<i32>) -> Self {
        self.state = self.state.assign_col(WebhookLogDbCol::ResponseStatus.as_sql(), val.into());
        self
    }
    pub fn set_response_body(mut self, val: Option<String>) -> Self {
        self.state = self.state.assign_col(WebhookLogDbCol::ResponseBody.as_sql(), val.into());
        self
    }
    pub fn set_duration_ms(mut self, val: Option<i32>) -> Self {
        self.state = self.state.assign_col(WebhookLogDbCol::DurationMs.as_sql(), val.into());
        self
    }
    pub fn set_created_at(mut self, val: time::OffsetDateTime) -> Self {
        self.state = self.state.assign_col(WebhookLogDbCol::CreatedAt.as_sql(), val.into());
        self
    }
    pub fn where_id(mut self, op: Op, val: uuid::Uuid) -> Self {
        let idx = self.state.where_binds.len() + 1;
        self.state.where_sql.push(format!("{} {} ${}", WebhookLogDbCol::Id.as_sql(), op.as_sql(), idx));
        self.state.where_binds.push(val.into());
        self
    }
    pub fn where_request_url(mut self, op: Op, val: String) -> Self {
        let idx = self.state.where_binds.len() + 1;
        self.state.where_sql.push(format!("{} {} ${}", WebhookLogDbCol::RequestUrl.as_sql(), op.as_sql(), idx));
        self.state.where_binds.push(val.into());
        self
    }
    pub fn where_request_method(mut self, op: Op, val: String) -> Self {
        let idx = self.state.where_binds.len() + 1;
        self.state.where_sql.push(format!("{} {} ${}", WebhookLogDbCol::RequestMethod.as_sql(), op.as_sql(), idx));
        self.state.where_binds.push(val.into());
        self
    }
    pub fn where_request_headers(mut self, op: Op, val: Option<serde_json::Value>) -> Self {
        let idx = self.state.where_binds.len() + 1;
        self.state.where_sql.push(format!("{} {} ${}", WebhookLogDbCol::RequestHeaders.as_sql(), op.as_sql(), idx));
        self.state.where_binds.push(val.into());
        self
    }
    pub fn where_request_body(mut self, op: Op, val: Option<String>) -> Self {
        let idx = self.state.where_binds.len() + 1;
        self.state.where_sql.push(format!("{} {} ${}", WebhookLogDbCol::RequestBody.as_sql(), op.as_sql(), idx));
        self.state.where_binds.push(val.into());
        self
    }
    pub fn where_response_status(mut self, op: Op, val: Option<i32>) -> Self {
        let idx = self.state.where_binds.len() + 1;
        self.state.where_sql.push(format!("{} {} ${}", WebhookLogDbCol::ResponseStatus.as_sql(), op.as_sql(), idx));
        self.state.where_binds.push(val.into());
        self
    }
    pub fn where_response_body(mut self, op: Op, val: Option<String>) -> Self {
        let idx = self.state.where_binds.len() + 1;
        self.state.where_sql.push(format!("{} {} ${}", WebhookLogDbCol::ResponseBody.as_sql(), op.as_sql(), idx));
        self.state.where_binds.push(val.into());
        self
    }
    pub fn where_duration_ms(mut self, op: Op, val: Option<i32>) -> Self {
        let idx = self.state.where_binds.len() + 1;
        self.state.where_sql.push(format!("{} {} ${}", WebhookLogDbCol::DurationMs.as_sql(), op.as_sql(), idx));
        self.state.where_binds.push(val.into());
        self
    }
    pub fn where_created_at(mut self, op: Op, val: time::OffsetDateTime) -> Self {
        let idx = self.state.where_binds.len() + 1;
        self.state.where_sql.push(format!("{} {} ${}", WebhookLogDbCol::CreatedAt.as_sql(), op.as_sql(), idx));
        self.state.where_binds.push(val.into());
        self
    }
...
pub async fn save(self) -> Result<u64> {
    ...
    async fn save_with_db<'tx>(self, db: DbConn<'tx>, observer_changes: Option<WebhookLogChanges>) -> Result<u64> {
        ...
        let select_sql = format!("SELECT id FROM webhook_logs WHERE {}", state.where_sql.join(" AND "));
...
impl core_db::common::model_api::QueryModel for WebhookLogModel {
    const DEFAULT_SELECT: &'static str = "id, request_url, request_method, request_headers, request_body, response_status, response_body, duration_ms, created_at";
    const HAS_SOFT_DELETE: bool = false;
...
impl core_db::common::model_api::CreateModel for WebhookLogModel {
    fn create_save<'db>(state: CreateState<'db>) -> core_db::common::model_api::BoxModelFuture<'db, Self::Record> {
        Box::pin(async move {
            let builder = WebhookLogCreateInner::from_state(state);
            let db = builder.state.db.clone();
            let base_url = builder.state.base_url.clone();
            let created = builder.save().await?;
            Query::<WebhookLogModel>::new_with_base_url(db, base_url).find(created.id.clone()).await?.ok_or_else(|| anyhow::anyhow!("webhook_logs: created record not found"))
        })
    }
...
impl core_db::common::model_api::CreateField<WebhookLogModel> for WebhookLogDbCol {
    ...
    fn set<'db>(field: Self, state: CreateState<'db>, value: BindValue) -> anyhow::Result<CreateState<'db>> {
        let value = <WebhookLogModel as core_db::common::model_api::CreateModel>::transform_create_value(field.as_sql(), value)?;
...
impl core_db::common::model_api::PatchModel for WebhookLogModel {
    fn patch_from_query<'db>(mut state: QueryState<'db>) -> PatchState<'db> {
        ...
        let mut ps = PatchState::new(db, base_url, "webhook_logs");
        ps.where_sql.push(format!("{} IN ({})", WebhookLogDbCol::Id.as_sql(), scope_sql));
        ps.where_binds = binds;
        ps
    }
    fn patch_save<'db>(state: PatchState<'db>) -> core_db::common::model_api::BoxModelFuture<'db, u64> {
        Box::pin(async move {
            let builder = WebhookLogPatchInner::from_state(state);
            builder.save().await
        })
    }
    fn patch_fetch<'db>(state: PatchState<'db>) -> core_db::common::model_api::BoxModelFuture<'db, Vec<Self::Record>> {
        Box::pin(async move {
            ...
            let query = Query::<WebhookLogModel>::new_with_base_url(db, base_url);
            let binds: Vec<BindValue> = target_ids.iter().cloned().map(Into::into).collect();
            let state = query.into_inner().where_in_str(WebhookLogDbCol::Id.as_sql(), &binds);
...
impl core_db::common::model_api::PatchAssignField<WebhookLogModel> for WebhookLogDbCol {
    ...
    fn assign<'db>(field: Self, state: PatchState<'db>, value: BindValue) -> anyhow::Result<PatchState<'db>> {
        let value = <WebhookLogModel as core_db::common::model_api::PatchModel>::transform_patch_value(field.as_sql(), value)?;
        Ok(state.assign_col(field.as_sql(), value))
    }
}

impl core_db::common::model_api::ColExpr for WebhookLogDbCol {
