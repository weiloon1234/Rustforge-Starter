...
impl core_db::common::model_api::QueryModel for WithdrawalModel {
    ...
    fn query_root<'db>(db: DbConn<'db>, base_url: Option<String>) -> Self::InnerQuery<'db> {
        QueryState::new(db, base_url, "id, owner_type, owner_id, admin_id, credit_type, withdrawal_method, bank_id, bank_account_name, bank_account_number, crypto_network_id, crypto_wallet_address, conversion_rate, status, amount, fee, net_amount, related_key, params, remark, admin_remark, reviewed_at, created_at, updated_at")
    }
    fn query_all<'db>(state: Self::InnerQuery<'db>) -> core_db::common::model_api::BoxModelFuture<'db, Vec<Self::Record>> {
        Box::pin(async move { WithdrawalQueryInner::from_state(state).get().await })
    }
    fn query_first<'db>(state: Self::InnerQuery<'db>) -> core_db::common::model_api::BoxModelFuture<'db, Option<Self::Record>> {
        Box::pin(async move { WithdrawalQueryInner::from_state(state).first().await })
    }
    fn query_find<'db>(state: Self::InnerQuery<'db>, id: Self::Pk) -> core_db::common::model_api::BoxModelFuture<'db, Option<Self::Record>> {
        Box::pin(async move { WithdrawalQueryInner::from_state(state).find(id).await })
    }
    fn query_count<'db>(state: Self::InnerQuery<'db>) -> core_db::common::model_api::BoxModelFuture<'db, i64> {
        Box::pin(async move { WithdrawalQueryInner::from_state(state).count().await })
    }
    fn query_delete<'db>(state: Self::InnerQuery<'db>) -> core_db::common::model_api::BoxModelFuture<'db, u64> {
        Box::pin(async move { WithdrawalQueryInner::from_state(state).delete().await })
    }
    fn query_paginate<'db>(state: Self::InnerQuery<'db>, page: i64, per_page: i64) -> core_db::common::model_api::BoxModelFuture<'db, core_db::common::model_api::Page<Self::Record>> {
        Box::pin(async move {
            let page = WithdrawalQueryInner::from_state(state).paginate(page, per_page).await?;
...
impl core_db::common::model_api::QueryField<WithdrawalModel> for WithdrawalDbCol {
    type Value = BindValue;
    fn where_col<'db>(field: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: <Self as core_db::common::model_api::QueryField<WithdrawalModel>>::Value) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.where_col_str(field.as_sql(), op, value)
    }
    fn or_where_col<'db>(field: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: <Self as core_db::common::model_api::QueryField<WithdrawalModel>>::Value) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.or_where_col_str(field.as_sql(), op, value)
    }
    fn where_in<'db>(field: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, values: &[<Self as core_db::common::model_api::QueryField<WithdrawalModel>>::Value]) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.where_in_str(field.as_sql(), values)
    }
    fn order_by<'db>(field: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, dir: OrderDir) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.order_by_str(field.as_sql(), dir)
    }
    fn where_null<'db>(field: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state.where_null_str(field.as_sql())
    }
    fn where_not_null<'db>(field: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
...
{
    type Value = T;
    fn where_col<'db>(field: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: Self::Value) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
    ...
    fn or_where_col<'db>(field: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: Self::Value) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        let col = resolve_withdrawal_db_col(field.as_sql()).expect("typed generated column must resolve to an internal db column");
        state.or_where_col_str(col.as_sql(), op, value.into())
    }
    fn where_in<'db>(field: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, values: &[Self::Value]) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        let col = resolve_withdrawal_db_col(field.as_sql()).expect("typed generated column must resolve to an internal db column");
...
impl core_db::common::model_api::IncludeRelation<WithdrawalModel> for OneRelation<WithdrawalModel, AdminRow, 0> {
    fn include<'db>(_relation: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        state
    }
}
...
impl core_db::common::model_api::WhereHasRelation<WithdrawalModel> for OneRelation<WithdrawalModel, AdminRow, 0> {
    ...
    fn where_has<'db, F>(_relation: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, scope: F) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>
    where
        F: FnOnce(Query<'db, Self::Target>) -> Query<'db, Self::Target>,
    {
        WithdrawalQueryInner::from_state(state).where_has_admin(scope).into_state()
    }
    fn or_where_has<'db, F>(_relation: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, scope: F) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>
    where
        F: FnOnce(Query<'db, Self::Target>) -> Query<'db, Self::Target>,
    {
        WithdrawalQueryInner::from_state(state).or_where_has_admin(scope).into_state()
    }
}
...
impl core_db::common::model_api::WhereHasRelation<WithdrawalModel> for OneRelation<WithdrawalModel, BankRow, 1> {
    ...
    where
        F: FnOnce(Query<'db, Self::Target>) -> Query<'db, Self::Target>,
    {
        WithdrawalQueryInner::from_state(state).where_has_bank(scope).into_state()
    }
    fn or_where_has<'db, F>(_relation: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, scope: F) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>
    where
        F: FnOnce(Query<'db, Self::Target>) -> Query<'db, Self::Target>,
    {
        WithdrawalQueryInner::from_state(state).or_where_has_bank(scope).into_state()
    }
}
...
impl core_db::common::model_api::WhereHasRelation<WithdrawalModel> for OneRelation<WithdrawalModel, CryptoNetworkRow, 2> {
    ...
    where
        F: FnOnce(Query<'db, Self::Target>) -> Query<'db, Self::Target>,
    {
        WithdrawalQueryInner::from_state(state).where_has_crypto_network(scope).into_state()
    }
    fn or_where_has<'db, F>(_relation: Self, state: <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, scope: F) -> <WithdrawalModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>
    where
        F: FnOnce(Query<'db, Self::Target>) -> Query<'db, Self::Target>,
    {
        WithdrawalQueryInner::from_state(state).or_where_has_crypto_network(scope).into_state()
    }
}
